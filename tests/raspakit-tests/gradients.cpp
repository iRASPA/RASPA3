...
TEST(gradients, Test_2_CO2_in_ITQ_29_2x2x2_framework_molecule)
{
  ...
  atomData[3].position = double3(5.93355, 3.93355, 7.08255);
  atomData[4].position = double3(5.93355, 3.93355, 5.93355);
...
atomData) + Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);
...
TEST(gradients, Test_20_Na_Cl_in_Box_25x25x25)
{
  ...
  for (size_t i = 0; i < atomData.size(); ++i)
  {
    ...
    // finite difference x
    atomData[i].position.x = spanOfMoleculeAtoms[i].position.x + 0.5 * delta;
    x2 = Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);

    atomData[i].position.x = spanOfMoleculeAtoms[i].position.x - 0.5 * delta;
    x1 = Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);
    atomData[i].position.x = spanOfMoleculeAtoms[i].position.x;

    // finite difference y
    atomData[i].position.y = spanOfMoleculeAtoms[i].position.y + 0.5 * delta;
    y2 = Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);

    atomData[i].position.y = spanOfMoleculeAtoms[i].position.y - 0.5 * delta;
    y1 = Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);
    atomData[i].position.y = spanOfMoleculeAtoms[i].position.y;

    // finite difference z
    atomData[i].position.z = spanOfMoleculeAtoms[i].position.z + 0.5 * delta;
    z2 = Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);

    atomData[i].position.z = spanOfMoleculeAtoms[i].position.z - 0.5 * delta;
    z1 = Interactions::computeInterMolecularEnergy(system.forceField, system.simulationBox, atomData);
    atomData[i].position.z = spanOfMoleculeAtoms[i].position.z;
