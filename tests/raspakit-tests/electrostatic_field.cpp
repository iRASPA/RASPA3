...
TEST(electrostatic_field, Test_reference_system_2)
{
  ...
  Component c1 = Component(
      ...
      {// double3 position, double charge, double lambda, uint32_t moleculeId, uint16_t type, uint8_t componentId,
       // uint8_t groupId
       Atom(double3(0.0, 0.0, 0.0), 0.5, 1.0, 0, 0, 0, false, false), Atom(double3(0.0, 0.0, 0.0), -1.25, 1.0, 0, 1, 0, false, false)},
      5, 21);
  Component c2 = Component(
      1, forceField, "t2", 0.0, 0.0, 0.0,
      {// double3 position, double charge, double lambda, uint32_t moleculeId, uint16_t type, uint8_t componentId,
       // uint8_t groupId
       Atom(double3(0.0, 0.0, 0.0), 1.5, 1.0, 1, 2, 1, false, false), Atom(double3(0.0, 0.0, 0.0), -0.75, 1.0, 1, 3, 1, false, false)},
      5, 21);
