...
TEST(MC_GIBBS_DRIFT, translation_rotation_reinsertion_volume)
{
  ...
  System systemVapor = System(0, forceField, box, 300.0, 1e4, 1.0, {}, {co2, methane, water}, {50, 55, 80}, 5, systemProbabilities);
  System systemLiquid = System(1, forceField, box, 300.0, 1e4, 1.0, {}, {co2, methane, water}, {50, 55, 80}, 5, systemProbabilities);
