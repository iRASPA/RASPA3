...
TEST(FindSpacegroupNoPartialOccupancies, Triclinic)
{
...
TEST(FindSpacegroupNoPartialOccupancies, Monoclinic)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);
...
TEST(FindSpacegroupNoPartialOccupancies, Orthorhombic)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);

  const std::map<std::string, size_t> testData = {std::make_pair("spglibtestdata/orthorhombic/POSCAR-016", 16),
                                                  ...
                                                  std::make_pair("spglibtestdata/orthorhombic/POSCAR-025", 25),
                                                  ...
                                                  std::make_pair("spglibtestdata/orthorhombic/POSCAR-047-2", 47),
...
TEST(FindSpacegroupNoPartialOccupancies, Tetragonal)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);

  const std::map<std::string, size_t> testData = {std::make_pair("spglibtestdata/tetragonal/POSCAR-075", 75),
                                                  ...
                                                  std::make_pair("spglibtestdata/tetragonal/POSCAR-082", 82),
                                                  std::make_pair("spglibtestdata/tetragonal/POSCAR-082-2", 82),
                                                  std::make_pair("spglibtestdata/tetragonal/POSCAR-083", 83),
                                                  std::make_pair("spglibtestdata/tetragonal/POSCAR-083-2", 83),
                                                  ...
                                                  std::make_pair("spglibtestdata/tetragonal/POSCAR-109", 109),
                                                  ...
                                                  std::make_pair("spglibtestdata/tetragonal/POSCAR-134-2", 134),
...
TEST(FindSpacegroupNoPartialOccupancies, Trigonal)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);

  const std::map<std::string, size_t> testData = {std::make_pair("spglibtestdata/trigonal/POSCAR-143", 143),
...
TEST(FindSpacegroupNoPartialOccupancies, Hexagonal)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);

  const std::map<std::string, size_t> testData = {std::make_pair("spglibtestdata/hexagonal/POSCAR-168", 168),
                                                  ...
                                                  std::make_pair("spglibtestdata/hexagonal/POSCAR-187", 187),
...
TEST(FindSpacegroupNoPartialOccupancies, Cubic)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);

  const std::map<std::string, size_t> testData = {std::make_pair("spglibtestdata/cubic/POSCAR-195", 195),
                                                  ...
                                                  std::make_pair("spglibtestdata/cubic/POSCAR-208-2", 208),
                                                  ...
                                                  std::make_pair("spglibtestdata/cubic/POSCAR-216", 216),
                                                  ...
                                                  std::make_pair("spglibtestdata/cubic/POSCAR-225-2", 225),
...
TEST(FindSpacegroupNoPartialOccupancies, Virtual)
{
  std::random_device rd;
  std::mt19937_64 mt(rd());
  std::uniform_real_distribution<double> dist(-0.5, 0.5);
  ...
  const std::map<std::string, size_t> testData = {
      ...
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-4-227-77", 4),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-4-227-81", 4),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-4-227-96", 4),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-4-230-conv-59", 4),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-221-32", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-222-32", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-223-32", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-224-32", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-227-45", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-227-75", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-227-98", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-230-conv-40", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR-5-230-conv-43", 5),
      std::make_pair("spglibtestdata/virtual_structure/POSCAR