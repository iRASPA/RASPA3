...
std::string::const_iterator Scanner::find_first_not_of(const std::string& chars, const std::string& text, std::string::const_iterator location)
{
...
std::string::const_iterator Scanner::find_first_of(const std::string& chars, const std::string& text, std::string::const_iterator location)
{
    std::string::const_iterator it = location;
    std::string::const_iterator end = text.cend();
    while (it != end)
...
{
    std::string::const_iterator newlineLocation = find_first_of(CharacterSet::newlineCharacter().string(), _string, _scanLocation);
...
{
    return _scanLocation >= _string.cend();
}
