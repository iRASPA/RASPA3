...
export inline float3 operator+(const float3& a, const float3& b)
{
...
export inline float3 operator*(const float3& a, float b)
{
	return float3(a.x * b, a.y * b, a.z * b);
}

export inline float3 operator*(float a, const float3& b)
{
