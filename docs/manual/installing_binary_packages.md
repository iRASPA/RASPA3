...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_arm64_ubuntu-25.deb
apt-get install ./raspa_3.0.10_arm64_ubuntu-25.deb
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_arm64_ubuntu-24.deb
apt-get install ./raspa_3.0.10_arm64_ubuntu-24.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_arm64_debian-13.deb
apt-get install ./raspa_3.0.10_arm64_debian-13.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-25-core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-25-core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-25_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-25_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-24-core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-24-core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-24_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-24_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-22-core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-22-core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-22_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-22_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-20-core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-20-core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_ubuntu-20_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_ubuntu-20_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-13_core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_debian-13_core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-13_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_debian-13_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-12_core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_debian-12_core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-12_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_debian-12_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-11_core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_debian-11_core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-11_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_debian-11_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-10_core-avx2.deb
apt-get install ./raspa_3.0.10_amd64_debian-10_core-avx2.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
apt update
apt install wget 
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa_3.0.10_amd64_debian-10_skylake-avx512.deb
apt-get install ./raspa_3.0.10_amd64_debian-10_skylake-avx512.deb
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
pacman -Sy
pacman -S wget
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1-x86_64-core-avx2.pkg.tar.zst
pacman -U ./raspa-3.0.10-1-x86_64-core-avx2.pkg.tar.zst
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
pacman -Sy
pacman -S wget
wget https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1-x86_64-skylake-avx512.pkg.tar.zst
pacman -U ./raspa-3.0.10-1-x86_64-skylake-avx512.pkg.tar.zst
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.almalinux.el9.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: almalinux/9-base
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.almalinux.el9.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.almalinux.el8.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: almalinux/8-base
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.almalinux.el8.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el9.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: rockylinux/rockylinux:9
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el9.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el8.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: rockylinux/rockylinux:8
```
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el8.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
yum install blas
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el7.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
yum install blas
yum install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el7.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
```
yum install --nogpgcheck  https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el6.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
```
yum install --nogpgcheck https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.el6.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:41
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc41.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:41
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc41.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:40
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc40.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:40
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc40.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:39
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc39.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:39
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc39.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:38
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc38.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:38
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc38.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:37
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc37.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:37
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc37.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:36
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc36.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:36
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc36.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:35
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc35.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: fedora:35
```
dnf install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.fc35.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-tumbleweed.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: opensuse/tumbleweed
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-tumbleweed.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.6.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: opensuse/leap:15.6
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.6.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.5.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: opensuse/leap:15.5
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.5.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.4.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: opensuse/leap:15.4
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.4.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.3.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: opensuse/leap:15.3
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.3.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.2.x86_64.core-avx2.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
...
tested on: opensuse/leap:15.2
```
zypper install https://github.com/iRASPA/RASPA3/releases/download/v3.0.10/raspa-3.0.10-1.opensuse-leap-15.2.x86_64.skylake-avx512.rpm
/usr/share/raspa3/tests/unit_tests_raspakit
```
