...
TEST(FindPointgroupNoPartialOccupancies, Triclinic)
{
  ...
  for (auto& [fileName, pointGroupTargetValue] : testData)
  {
    ...
    std::optional<SKPointGroup> pointGroup = SKSpaceGroup::findPointGroup(unitCell, randomlyShiftedAtoms, allowPartialOccupancies, symmetryPrecision);
...
TEST(FindPointgroupNoPartialOccupancies, Cubic)
{
  ...
  const std::map<std::string, size_t> testData =
  {
    ...
    std::make_pair("spglibtestdata/cubic/POSCAR-195-2",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-196",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-196-2",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-197",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-197-2",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-198",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-198-2",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-199",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-199-2",  28),
    std::make_pair("spglibtestdata/cubic/POSCAR-200",  29),
    std::make_pair("spglibtestdata/cubic/POSCAR-200-2",  29),
    std::make_pair("spglibtestdata/cubic/POSCAR-205",  29),
    std::make_pair("spglibtestdata/cubic/POSCAR-205-3",  29),
    std::make_pair("spglibtestdata/cubic/POSCAR-206",  29),
    std::make_pair("spglibtestdata/cubic/POSCAR-206-2",  29),
    std::make_pair("spglibtestdata/cubic/POSCAR-207",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-208",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-208-2",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-209",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-210",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-210-2",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-211",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-212",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-212-2",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-213",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-213-2",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-214",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-214-2",  30),
    std::make_pair("spglibtestdata/cubic/POSCAR-215",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-215-2",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-216",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-216-2",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-217",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-217-2",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-218",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-218-2",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-219",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-219-2",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-220",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-220-2",  31),
    std::make_pair("spglibtestdata/cubic/POSCAR-221",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-221-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-222",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-222-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-223",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-223-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-224",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-224-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-225",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-225-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-226",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-226-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-227",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-227-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-228",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-228-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-229",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-229-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-230",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-230-2",  32),
    std::make_pair("spglibtestdata/cubic/POSCAR-230-3",  32),
