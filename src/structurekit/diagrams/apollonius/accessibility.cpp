...
ApolloniusAccessibility ApolloniusAccessibility::create(const UnitCell& unitCell,
                                                        ...
                                                        const std::vector<double>& radii, double probeRadius)
{
  ...
  result.diagram = ApolloniusPoreNetwork::create(unitCell, fractionalPositions, inflatedRadii);
