...
export module energy_opencl_well_field;
...
// The GPU well field and the vertex refinement that slides the extracted sheet onto the analytic well
// floor. Arithmetic is single precision with a double-float accumulator, Apple Silicon having no
// cl_khr_fp64. The processor builder remains the reference.
export struct WellFieldOpenCL
{
  ...
  static const char *doubleFloatSource;
