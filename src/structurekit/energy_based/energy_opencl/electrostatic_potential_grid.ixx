...
export module energy_opencl_electrostatic_potential_grid;
...
// Builds the far part of the Ewald potential on the GPU, one work item per voxel, each summing over the wave
// vectors that survived the cutoff in reciprocal space.
//
...
export struct ElectrostaticPotentialGridOpenCL
{
  ...
  static const char *reciprocalKernelSource;
};
