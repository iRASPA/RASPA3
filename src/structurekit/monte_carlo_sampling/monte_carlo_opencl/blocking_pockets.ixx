...
export module mc_opencl_blocking_pockets;
...
// The spheres that block the pockets from a roadmap of the void built on the GPU.
//
// The reading itself is `MC_BlockingPockets`, which this is, and it is not repeated here. What a roadmap costs is
...
export struct MC_OpenCL_BlockingPockets : MC_BlockingPockets
{
