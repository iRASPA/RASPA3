...
export module mc_opencl_pore_diameters;
...
// The largest included and free sphere diameters from a roadmap of the void built on the GPU.
//
// The reading itself is `MC_PoreDiameters`, which this is, and it is not repeated here. What a roadmap costs is
...
export struct MC_OpenCL_PoreDiameters : MC_PoreDiameters
{
