...
export module mc_opencl_pore_volume;
...
// The void fraction and the pore volume from a roadmap of the void built on the GPU.
//
// The reading itself is `MC_PoreVolume`, which this is, and it is not repeated here. What a roadmap costs is
...
export struct MC_OpenCL_PoreVolume : MC_PoreVolume
{
