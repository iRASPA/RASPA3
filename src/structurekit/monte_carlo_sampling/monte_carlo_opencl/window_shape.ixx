...
export module mc_opencl_window_shape;
...
// The shape of the windows from a roadmap of the void built on the GPU.
//
// The reading itself is `MC_WindowShape`, which this is, and it is not repeated here. What a roadmap costs is
...
export struct MC_OpenCL_WindowShape : MC_WindowShape
{
