...
private:
	...
	std::string::const_iterator find_first_not_of(const std::string& chars, const std::string& text, std::string::const_iterator location);
	std::string::const_iterator find_first_of(const std::string& chars, const std::string& text, std::string::const_iterator location);
};
