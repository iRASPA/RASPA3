...
export struct MCMoveProbabilitiesSystem
{
   ...
   * \param nCMCProbability Probability for the NCMC move.
   */
  MCMoveProbabilitiesSystem(double volumeChangeProbability = 0.0, double gibbsVolumeChangeProbability = 0.0,
                            double parallelTemperingProbability = 0.0, double hybridMCProbability = 0.0, double nCMCProbability = 0.0);
  ...
  double nCMCProbability;               ///< Probability for NCMC moves.
