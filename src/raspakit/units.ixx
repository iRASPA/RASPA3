...
export namespace Units
{
  ...
  double PolarizilibityConversionFactor =
  ...
  void setUnits(Units::System unit_system)
  {
    ...
    case System::RASPA:
      ...
      DielectricConstantConversionFactor = TimeUnit * TimeUnit * ChargeUnit * ChargeUnit / (AtomicMassUnit * LengthUnit * LengthUnit * LengthUnit);
      CoulombicConversionFactor = ChargeUnit * ChargeUnit / (4.0 * std::numbers::pi * DielectricConstantVacuum * LengthUnit * EnergyConversionFactor);
