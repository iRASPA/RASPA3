  ...
  switch (growType)
  {
    default:
      return CBMC::growRigidMoleculeSwapInsertion(
          random, frameworkComponents, component, hasExternalField, components, forceField, simulationBox,
...
[[nodiscard]] std::optional<ChainData> CBMC::growMoleculeReinsertion(
    ...
    size_t selectedMolecule, Molecule &molecule, std::span<Atom> molecule_atoms,
    size_t numberOfTrialDirections) noexcept
{
  return CBMC::growRigidMoleculeReinsertion(random, frameworkComponents, component, hasExternalField, components,
                                            forceField, simulationBox, frameworkAtoms, moleculeAtoms, beta,
    ...
    size_t numberOfTrialDirections) noexcept
{
  return CBMC::retraceRigidMoleculeReinsertion(
      random, frameworkComponents, component, hasExternalField, components, forceField, simulationBox, frameworkAtoms,
      moleculeAtoms, beta, cutOffFrameworkVDW, cutOffMoleculeVDW, cutOffCoulomb, selectedComponent, selectedMolecule,
...
{
  return CBMC::retraceRigidMoleculeSwapDeletion(random, frameworkComponents, component, hasExternalField, components,
                                                forceField, simulationBox, frameworkAtoms, moleculeAtoms, beta,
                                                cutOffFrameworkVDW, cutOffMoleculeVDW, cutOffCoulomb, selectedComponent,
