...
std::vector<double> PropertyRadialDistributionFunction::averagedProbabilityHistogram(size_t blockIndex, size_t atomTypeA, size_t atomTypeB) const
{
...
std::vector<double> PropertyRadialDistributionFunction::averagedProbabilityHistogram(size_t atomTypeA, size_t atomTypeB) const
{
  size_t index_pseudo_atoms = atomTypeB + atomTypeA * numberOfPseudoAtoms;
...
PropertyRadialDistributionFunction::averageProbabilityHistogram(size_t atomTypeA, size_t atomTypeB) const
{
...
Archive<std::ifstream> &operator>>(Archive<std::ifstream> &archive, PropertyRadialDistributionFunction &rdf)
{
  ...
  if(versionNumber > rdf.versionNumber)
  {
    ...
    throw std::runtime_error(std::format("Invalid version reading 'PropertyRadialDistributionFunction' at line {} in file {}\n",
