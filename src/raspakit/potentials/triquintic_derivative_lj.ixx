 ...
 */
[[clang::always_inline]] inline TriquinticDerivativeFactor potentialLJTriquinticDerivative(const ForceField& forcefield,
                                                                                           const double& rr,
                                                                                           const size_t& typeA,
                                                                                           const size_t& typeB)
{
  ...
  double temp3 = (arg2 / rr) * (arg2 / rr) * (arg2 / rr);

  return TriquinticDerivativeFactor(
      arg1 * (temp3 * temp3 - temp3) - arg3, -6.0 * arg1 * (2.0 * temp3 * temp3 - temp3) / rr,
