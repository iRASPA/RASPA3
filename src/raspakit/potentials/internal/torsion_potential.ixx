...
export enum class TorsionType : std::size_t { Fixed = 0, Harmonic = 1, HarmonicCosine = 2, 
                                         ...
                                         FourierSeries = 13, FourierSeries2 = 14
                                        };
...
export struct TorsionPotential
{
  ...
  static inline std::map<std::string, TorsionType, caseInsensitiveComparator> definitionForString{
      {"Fixed", TorsionType::Fixed}, {"HARMONIC", TorsionType::Harmonic}, {"HARMONIC_COSINE", TorsionType::HarmonicCosine},
      {"THREE_COSINE", TorsionType::ThreeCosine}, {"SIX_COSINE", TorsionType::RyckaertBellemans},
      {"TRAPPE", TorsionType::TraPPE}, {"TRAPPE_EXTENDED", TorsionType::TraPPE_Extended},
      {"CVFF", TorsionType::CVFF}, {"CFF", TorsionType::CFF}, {"CFF2", TorsionType::CFF2},
      {"OPLS", TorsionType::OPLS}, {"MM3", TorsionType::MM3},
      {"FOURIER_SERIES", TorsionType::FourierSeries}, {"FOURIER_SERIES2", TorsionType::FourierSeries2} };
