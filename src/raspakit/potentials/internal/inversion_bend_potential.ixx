 ...
 *
 * The InversionBendPotential struct encapsulates the type of inversion_bend and associated parameters between two particles.
 * It includes versioning for serialization, inversion_bend type, identifiers of inversion_bended particles, and inversion_bend parameters.
 */
export struct InversionBendPotential
{
  ...
  static inline std::map<std::string, InversionBendType, caseInsensitiveComparator> definitionForString{
      {"HARMONIC", InversionBendType::Harmonic}, {"HARMONIC_COSINE", InversionBendType::HarmonicCosine},
      {"PLANAR", InversionBendType::Planar},  {"HARMONIC2", InversionBendType::Harmonic2},
      {"HARMONIC_COSINE2", InversionBendType::HarmonicCosine2}, {"PLANAR2", InversionBendType::Planar2},
