 ...
 * It includes versioning for serialization, ureyBradley type, identifiers of ureyBradleyed particles, and ureyBradley parameters.
 */
export struct UreyBradleyPotential
{
  ...
  static inline std::map<std::string, UreyBradleyType, caseInsensitiveComparator> definitionForString{
      {"FIXED", UreyBradleyType::Fixed}, {"HARMONIC", UreyBradleyType::Harmonic},
      {"CORE_SHELL_SPRING", UreyBradleyType::CoreShellSpring}, {"MORSE", UreyBradleyType::Morse}, 
      {"LJ_12_6", UreyBradleyType::LJ_12_6}, {"LENNARD_JONES", UreyBradleyType::LennardJones},
      {"BUCKINGHAM", UreyBradleyType::Buckingham}, {"RESTRAINED_HARMONIC", UreyBradleyType::RestrainedHarmonic},
      {"QUARTIC", UreyBradleyType::Quartic}, {"CFF_QUARTIC", UreyBradleyType::CFF_Quartic}, {"MM3", UreyBradleyType::MM3}};
