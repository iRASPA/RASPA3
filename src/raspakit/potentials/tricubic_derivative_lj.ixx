 ...
 */
[[clang::always_inline]] inline TricubicDerivativeFactor potentialLJTricubicDerivative(const ForceField& forcefield,
                                                                                       const double& rr,
                                                                                       const size_t& typeA,
                                                                                       const size_t& typeB)
{
  ...
  return TricubicDerivativeFactor(arg1 * (temp3 * temp3 - temp3) - arg3,
