...
void ApolloniusPoreAnalysis::run(const ForceField& forceField, const Framework& framework, std::string probePseudoAtom)
{
  ...
  ApolloniusPoreNetwork pores = ApolloniusPoreNetwork::create(framework.simulationBox, fractionalPositions, radii);
