...
void GridVoidFraction::run(const ForceField &forceField, const Framework &framework, std::string probePseudoAtom,
                           uint3 gridSize)
{
  ...
  if (components.numberOfPockets > 0)
  {
    ...
    for (const GridPore &pore : components.pores)
    {
      ...
      std::print(myfile, "Pocket: {:11.7f} {:11.7f} {:11.7f} {:11.5f} {:8} {:11.5f} {:11.5f}\n",
                 ...
                 pore.numberOfVoxels, pore.largestClearance, equivalentRadius);
    }
  }
