...
export struct ReweightedHistogram
{
  ...
  struct Sample
  {
    ...
    friend Archive<std::ofstream>& operator<<(Archive<std::ofstream>& archive, const Sample& s);
    friend Archive<std::ifstream>& operator>>(Archive<std::ifstream>& archive, Sample& s);
  };
  ...
  friend Archive<std::ofstream>& operator<<(Archive<std::ofstream>& archive, const ReweightedHistogram& rh);
  friend Archive<std::ifstream>& operator>>(Archive<std::ifstream>& archive, ReweightedHistogram& rh);
};
