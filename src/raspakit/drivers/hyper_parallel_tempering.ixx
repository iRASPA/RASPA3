...
export struct HyperParallelTempering
{
  ...
  friend Archive<std::ofstream>& operator<<(Archive<std::ofstream>& archive, const HyperParallelTempering& hpt);
  friend Archive<std::ifstream>& operator>>(Archive<std::ifstream>& archive, HyperParallelTempering& hpt);
};
