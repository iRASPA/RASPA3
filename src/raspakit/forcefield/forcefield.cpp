...
ForceField::ForceField(std::string filePath)
{
  ...
  {
    double width =
        parsed_data.value("ExternalFieldRectangularChannelWidth", parsed_data["ExternalFieldRectangularChannelWidth"]);
    externalFieldGeometryParameters.x = width;
  }

  if (parsed_data.contains("ExternalFieldRectangularChannelHeight"))
  {
    double height = parsed_data.value("ExternalFieldRectangularChannelHeight",
                                      parsed_data["ExternalFieldRectangularChannelHeight"]);
    externalFieldGeometryParameters.y = height;
  }

  if (parsed_data.contains("ExternalPotentialEnergySurfaceOrigin"))
  {
    potentialEnergySurfaceOrigin =
    ...
    for (std::size_t j = i; j < numberOfPseudoAtoms; ++j)
    {
      switch (data[i * numberOfPseudoAtoms + j].type)
      {
        case VDWParameters::Type::LennardJones:
          std::print(stream, "{:8} - {:8} {:14} p₀{}: {:9.5f} [{}], p₁: {:8.5f} [{}]\n", pseudoAtoms[i].name,
...
ForceField ForceField::makeMetalOrganicFrameworkForceField(double rc, bool shifted, bool tailCorrections, bool useEwald)
{
  return ForceField({{"-", false, 0.0, 0.0, 0.0, 0, false},
                    ...
                    {{1.0, 1.0},
                     ...
                     {1.0, 1.0},          // 117 "Ts"
                     {1.0, 1.0},          // 118 "Og"
                     {10.9, 2.64},  // probe-He  J.O. Hirschfelder et al., Molecular Theory of Gases and Liquids, Wiley,
...
ForceField ForceField::makeZeoPlusPlusForceField(double rc, bool shifted, bool tailCorrections, bool useEwald)
{
  return ForceField(
      ...
      {{1.0, 2.0 * 1.00},  // custom
       ...
       {1.0, 2.0 * 1.70}, {1.0, 2.0 * 1.55}, {1.0, 2.0 * 1.52}, {1.0, 2.0 * 1.47}, {1.0, 2.0 * 1.54}, {1.0, 2.0 * 2.27},
       {1.0, 2.0 * 1.73}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.10}, {1.0, 2.0 * 1.80}, {1.0, 2.0 * 1.80}, {1.0, 2.0 * 1.75},
       {1.0, 2.0 * 1.88}, {1.0, 2.0 * 2.75}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 1.63}, {1.0, 2.0 * 1.40},
       {1.0, 2.0 * 1.39}, {1.0, 2.0 * 1.87}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 1.85}, {1.0, 2.0 * 1.90}, {1.0, 2.0 * 1.85},
       {1.0, 2.0 * 2.02}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 1.63}, {1.0, 2.0 * 1.72},
       {1.0, 2.0 * 1.58}, {1.0, 2.0 * 1.93}, {1.0, 2.0 * 2.17}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.06}, {1.0, 2.0 * 1.98},
       {1.0, 2.0 * 2.16}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 1.72}, {1.0, 2.0 * 1.66}, {1.0, 2.0 * 1.55}, {1.0, 2.0 * 1.96}, {1.0, 2.0 * 2.02}, {1.0, 2.0 * 2.00},
       {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00}, {1.0, 2.0 * 2.00},
