...
std::string Units::printStatus()
{
  ...
  case System::RASPA:
    ...
    std::print(stream, "Unit of velocity:                         {} [{}]\n", Units::VelocityConversionFactor, unitOfVelocityString);
    std::print(stream, "Unit of force:                            {} [{}]\n", Units::ForceConversionFactor, unitOfForceString);
    std::print(stream, "Unit of diffusion:                        {} [{}]\n", Units::DiffusionConversionFactor, unitOfDiffusionString);
    std::print(stream, "Unit of acceleration:                     {} [{}]\n", Units::AccelerationConversionFactor, unitOfAccelerationString);
    std::print(stream, "Unit of torque:                           {} [{}]\n", Units::TorqueConversionFactor, unitOfTorqueString);
    std::print(stream, "Unit of pressure:                         {} [{}]\n", Units::PressureConversionFactor, unitOfPressureString);
    std::print(stream, "Unit of volume:                           {} [{}]\n", Units::VolumeConversionFactor, unitOfVolumeString);
    std::print(stream, "Unit of density:                          {} [{}]\n", Units::DensityConversionFactor, unitOfDensityString);
    std::print(stream, "Unit of dynamic viscosity:                {} [{}]\n", Units::DynamicViscosityConversionFactor, unitOfDynamicViscosityString);
    std::print(stream, "Unit of enthalpy:                         {} [{}]\n", Units::EnthalpyConversionFactor, unitOfEnthalpyString);
    std::print(stream, "Unit of polarizability:                   {} [{}]\n", Units::PolarizilibityConversionFactor, unitOfPolarizabilityString);
    ...
    std::print(stream, "Unit of heat capacity:                    {} [{}]\n", Units::HeatCapacityConversionFactor, unitOfHeatCapacityString);
