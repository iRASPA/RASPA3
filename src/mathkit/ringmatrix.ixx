...
private:
    ...
    std::tuple<RingMatrix, RingMatrix, RingMatrix> ColumnReduction(RingMatrix A1, size_t col_1, size_t col_2, size_t row_start);
    std::pair<std::vector<int>, std::vector<int>> Conditioning(RingMatrix A, size_t col_1, size_t col_2, size_t row_start);
