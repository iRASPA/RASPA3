...
export union double4
{
  ...
  inline static double4 cross(const double4& v1, const double4& v2)
  {
    return double4(v1.y * v2.z - v1.z * v2.y, -v1.x * v2.z + v1.z * v2.x, v1.x * v2.y - v1.y * v2.x, 0.0);
  }
...
export inline double4 operator/(const double4& a, double b) { return double4(a.x / b, a.y / b, a.z / b, a.w / b); }
