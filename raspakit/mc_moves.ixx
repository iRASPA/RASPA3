...
export struct MC_Moves
{
  ...
  translationMove(RandomNumber &random, System& system, size_t selectedComponent, std::span<Atom> molecule) const;
  ...
  std::optional<RunningEnergy> 
  identityChangeMove(RandomNumber &random, System& system, size_t selectedComponent, 
                     size_t selectedMolecule, std::span<Atom> atoms);

  std::optional<RunningEnergy> 
  reinsertionMove(RandomNumber &random, System& system, size_t selectedComponent, 
                  size_t selectedMolecule, std::span<Atom> atoms);
  ...
  std::pair<std::optional<RunningEnergy>, double3> 
  deletionMove(RandomNumber &random, System& system, size_t selectedComponent, size_t selectedMolecule);  
  ...
  std::pair<std::optional<RunningEnergy>, double3> 
  swapMove_CFCMC_CBMC(RandomNumber &random, System& system, size_t selectedComponent, size_t selectedMolecule, 
                      bool insertionDisabled = false, bool deletionDisabled = false);
  ...
  std::optional<std::pair<RunningEnergy, RunningEnergy>> 
  GibbsSwapMove_CFCMC(RandomNumber &random, System& systemA, System& systemB, 
                      size_t selectedComponent, size_t &fractionalMoleculeSystem);

  std::optional<std::pair<RunningEnergy, RunningEnergy>> 
  GibbsSwapMove_CFCMC_CBMC(RandomNumber &random, System& systemA, System& systemB, 
                           size_t selectedComponent, size_t &fractionalMoleculeSystem);

  std::optional<RunningEnergy> 
  volumeMove(RandomNumber &random, System &system) const;

  std::optional<std::pair<RunningEnergy, RunningEnergy>> 
  GibbsVolumeMove(RandomNumber &random, System &systemA, System &systemB) const;

  std::optional<RunningEnergy> 
  reactionMove(RandomNumber &random, System& system, const std::vector<size_t> reactantStoichiometry, 
               const std::vector<size_t> productStoichiometry) const;

  std::optional<RunningEnergy> 
  reactionMove_CFCMC(RandomNumber &random, System& system, const std::vector<size_t> reactantStoichiometry, 
                     const std::vector<size_t> productStoichiometry) const;

  std::optional<RunningEnergy> 
  reactionMove_CFCMC_CBMC(RandomNumber &random, System& system, const std::vector<size_t> reactantStoichiometry, 
                          const std::vector<size_t> productStoichiometry) const;
