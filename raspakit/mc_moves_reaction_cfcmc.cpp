...
std::optional<RunningEnergy> MC_Moves::reactionMove_CFCMC(System& system, [[maybe_unused]] const std::vector<size_t> reactantStoichiometry, [[maybe_unused]] const std::vector<size_t> productStoichiometry) const
{
