...
std::optional<RunningEnergy> MC_Moves::reactionMove_CFCMC(System& system, const std::vector<size_t> reactantStoichiometry, const std::vector<size_t> productStoichiometry) const
{
