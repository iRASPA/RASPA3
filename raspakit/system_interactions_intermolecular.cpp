...
void System::computeInterMolecularVDWEnergy() noexcept
{
...
[[nodiscard]] std::optional<EnergyStatus> System::computeInterMolecularVDWEnergy(std::span<Atom> atoms, std::make_signed_t<std::size_t> skip) const noexcept
{
	double3 dr, s, t;
	double rr,energy;
