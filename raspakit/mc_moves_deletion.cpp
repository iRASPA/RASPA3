...
std::optional<RunningEnergy> MC_Moves::deletionMove(System& system, size_t selectedComponent, size_t selectedMolecule)
{
  ...
  if (system.numberOfIntegerMoleculesPerComponent[selectedComponent] > 0)
  {
      ...
      system.components[selectedComponent].mc_moves_timings.cpuTime_SwapDeletionMove_CBMC_NonEwald += (t2 - t1);
      ...
      system.components[selectedComponent].mc_moves_timings.cpuTime_SwapDeletionMove_CBMC_Ewald += (u2 - u1);
