...
std::optional<std::pair<RunningEnergy, RunningEnergy>> MC_Moves::GibbsSwapMove_CFCMC_CBMC([[maybe_unused]] System& systemA, [[maybe_unused]] System& systemB, size_t selectedComponent, [[maybe_unused]] size_t &fractionalMoleculeSystem)
{
  if (systemB.numberOfIntegerMoleculesPerComponent[selectedComponent] == 0) return std::nullopt;

 // PropertyLambdaProbabilityHistogram& lambda = systemA.components[selectedComponent].lambdaGC;
