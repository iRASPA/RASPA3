...
void MC_Move_Probabilities::clearMoveStatistics()
{
...
void MC_Move_Probabilities::optimizeMCMoves()
{
  statistics_TranslationMove.optimizeAcceptance();
  statistics_RotationMove.optimizeAcceptance();
}

void MC_Move_Probabilities::normalizeMoveProbabilties()
{
...
const std::string MC_Move_Probabilities::writeMCMoveStatistics() const
{
  std::ostringstream stream;
