...
SKSeitzIntegerMatrix::SKSeitzIntegerMatrix(char xvalue, char yvalue, char zvalue)
{
    ...
    int3 r1 = int3(SKSeitzIntegerMatrix::SeitzData[x].r1(), SKSeitzIntegerMatrix::SeitzData[y].r1(), SKSeitzIntegerMatrix::SeitzData[z].r1());
    int3 r2 = int3(SKSeitzIntegerMatrix::SeitzData[x].r2(), SKSeitzIntegerMatrix::SeitzData[y].r2(), SKSeitzIntegerMatrix::SeitzData[z].r2());
    int3 r3 = int3(SKSeitzIntegerMatrix::SeitzData[x].r3(), SKSeitzIntegerMatrix::SeitzData[y].r3(), SKSeitzIntegerMatrix::SeitzData[z].r3());
    this->rotation = SKRotationMatrix(r1, r2, r3);
    this->translation = int3(SKSeitzIntegerMatrix::SeitzData[x].t(), SKSeitzIntegerMatrix::SeitzData[y].t(), SKSeitzIntegerMatrix::SeitzData[z].t());
}
