...
algorithmStart:
    ...
    SKSymmetryCell cell = SKSymmetryCell(sqrt(A), sqrt(B), sqrt(C), acos(xi / (2.0 * sqrt(B) * sqrt(C))) * 180.0 / std::numbers::pi, acos(eta / (2.0 * sqrt(A) * sqrt(C))) * 180.0 / std::numbers::pi, acos(zeta / (2.0 * sqrt(A) * sqrt(B))) * 180.0 / std::numbers::pi);
